...
INC = -I./include -I/usr/local/include/opencv -I/usr/local/include

libpymodule.so: c_dll.cpp
	g++ -std=c++14 -fopenmp -fpic -Wall -shared c_dll.cpp -o libpymodule.so  $(LIBS) $(INC)
